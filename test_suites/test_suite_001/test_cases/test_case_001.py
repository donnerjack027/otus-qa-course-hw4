...
class TestCase_001_test_request:

    def __init__(self):
        super().__init__()

    def test_run(self, request_string):
        log.info("Running test case %s" % TestCase_001_test_request.__name__)
        ...
        try:
            ...
            response = Request.prepare_request(request_string)
            print(response)
            print(response.text)
